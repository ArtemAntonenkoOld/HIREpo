...
angular.module('yaMap',[]).
    ...
    factory('mapApiLoad',['yaMapSettings',function(yaMapSettings){
        ...
        var loadScript = function(url, callback){
            ...
            } else { // Р”СЂСѓРіРёРµ Р±СЂРѕСѓР·РµСЂС‹
    ...
    controller('YaMapCtrl',['$scope','mapApiLoad',function($scope,mapApiLoad){
        ...
        mapApiLoad(function(){
            ...
            self.addHotspotLayer = function(urlTemplate, keyTemplate, options){
                // РЎРѕР·РґР°РґРёРј РёСЃС‚РѕС‡РЅРёРє РґР°РЅРЅС‹С… СЃР»РѕСЏ Р°РєС‚РёРІРЅС‹С… РѕР±Р»Р°СЃС‚РµР№.
            ...
            compile: function(tElement) {
                ...
                return function(scope, element,attrs) {
                    ...
                    var getCenterCoordinates = function(center){
                        ...
                        if(!center){
                            //СѓСЃС‚Р°РЅР°РІР»РёРІР°РµРј РІ РєР°С‡РµСЃС‚РІРµ С†РµРЅС‚СЂР° РјРµСЃС‚РѕРїРѕР»РѕР¶РµРЅРёРµ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
                            mapApiLoad(function(){
                                ymaps.geolocation.get({
                                    // Р’С‹СЃС‚Р°РІР»СЏРµРј РѕРїС†РёСЋ РґР»СЏ РѕРїСЂРµРґРµР»РµРЅРёСЏ РїРѕР»РѕР¶РµРЅРёСЏ РїРѕ ip
                                    provider: 'yandex'//,
                                    // РљР°СЂС‚Р° Р°РІС‚РѕРјР°С‚РёС‡РµСЃРєРё РѕС‚С†РµРЅС‚СЂРёСЂСѓРµС‚СЃСЏ РїРѕ РїРѕР»РѕР¶РµРЅРёСЋ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ.
                            ...
                            //РїСЂРѕРІРѕРґРёРј РѕР±СЂР°С‚РЅРѕРµ РіРµРѕРєРѕРґРёСЂРѕРІР°РЅРёРµ
                            mapApiLoad(function(){
        ...
        return {
            ...
            compile:function(tElement){
                ...
                return function(scope, element,attrs,yaMap) {
                    ...
                    //РІРєР»СЋС‡РµРЅРёРµ РєР»Р°СЃС‚РµСЂРёР·Р°С†РёРё
